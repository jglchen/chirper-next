                ...
                <div className="flex justify-between h-16">
                    ...
                    <div className="hidden sm:flex sm:items-center sm:ml-6">
                        ...
                        <Dropdown
                            ...
                            width="48"
                            trigger={
                                <button className="flex items-center text-sm font-medium text-gray-500 dark:text-gray-300 hover:text-gray-700 focus:outline-none transition duration-150 ease-in-out">
                                    <div>{user?.name}</div>
                                    <div className="ml-1">
                                        <svg
