...
import { ChirpType, MsgErrorsType } from'@/lib/types';
...
export default function Chirp({ chirp, myFollowings, chirpsUpdate, chirpsRefreshDestroy, addMyFollowings, deleteMyFollowings }: ChirpProps) {
    ...
    //const myUserFollow = myFollowings.find((item: MyFollowingType) => item.followed_id == chirp.user.id);
            ...
            <div className="flex-1">
                <div className="flex justify-between items-center">
                    ...
                    <Dropdown
                       ...
                       {myFollowings.includes(chirp.user.id) ?
